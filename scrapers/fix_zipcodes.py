...
fix_zipcodes.py
–––––––––––––––
Replace placeholder ZIP codes in a real-estate CSV.
...
UA = "zip-fixer/1.0 (+https://github.com/your-repo)"
...
def main(path):
    ...
    out = src.with_name("listings_with_fixed_zips.csv")
    df.to_csv(out, index=False, quoting=csv.QUOTE_MINIMAL)
    print(f"\n✓  Updated {upd} ZIP codes.\n→  {out}")

if __name__ == "__main__":
    p = argparse.ArgumentParser()
    p.add_argument("csv", help="original listings CSV")
